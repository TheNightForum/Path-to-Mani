...
public class ShipMouseControl implements ShipUiControl {
  ...
  public ShipMouseControl(ManiApplication cmp) {
    myMoveCursor = cmp.getTexMan().getTex("controllers/cursorMove", null);
    myAttackCursor = cmp.getTexMan().getTex("controllers/cursorAttack", null);
    myFollowCursor = cmp.getTexMan().getTex("controllers/cursorFollow", null);
