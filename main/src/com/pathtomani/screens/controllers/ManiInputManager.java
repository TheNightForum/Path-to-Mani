...
package com.pathtomani.screens.controllers;
...
public class ManiInputManager {
  ...
  public ManiInputManager(TextureManager textureManager, float r) {
    ...
    myUiCursor = textureManager.getTex("controllers/cursor", null);
    ...
    FileHandle hoverSoundFile = FileManager.getInstance().getSoundsDirectory().child("controllers").child("uiHover.ogg");
